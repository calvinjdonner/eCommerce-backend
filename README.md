...
<p align='center'>
  ...
  ## Description 🗺️
   An application built using Express.js designed to demonstrate the architecture of e-commerce sites. GIFs are below with full videos in the images folder within the develop folder [here](./images)
